...
main_pages = [
    ...
    ('scientific-calculator.html', 0.9, 'weekly'),
    ('fraction-calculator.html', 0.7, 'weekly'),
    ('age-calculator.html', 0.7, 'weekly'),
    ('date-calculator.html', 0.7, 'weekly'),
    ('unit-converter.html', 0.7, 'weekly'),
    ('password-generator.html', 0.6, 'monthly'),
    ('student-loan-calculator.html', 0.8, 'weekly'),
    ('square-footage-calculator.html', 0.8, 'weekly'),
    ('grade-calculator.html', 0.7, 'weekly'),
    ('overtime-calculator.html', 0.7, 'weekly'),
    ('hours-calculator.html', 0.7, 'weekly'),
    ('body-fat-calculator.html', 0.8, 'weekly'),
    ('bmr-calculator.html', 0.8, 'weekly'),
    ('ideal-weight-calculator.html', 0.7, 'weekly'),
    ('pregnancy-calculator.html', 0.8, 'weekly'),
    ('pace-calculator.html', 0.7, 'weekly'),
